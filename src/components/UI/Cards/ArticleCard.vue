<template>
    <div class="main-body">
        <div class="flex">
            <div class="card">
                <div :class="{ header: true, collapse: isCollapsed }">
                    <div class="title">
                        <div>
                ...
                <div :class="{ content: true, full: isFull }">
